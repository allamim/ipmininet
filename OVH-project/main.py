...
class SimpleBGPTopo(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        as1_r12 = self.addRouter("as1_r12", config=RouterConfig)  # sinsgcs2g1nc5BABE
        ...
        ip6_rules = [
            ...
            # (telstra3,as1_r15)
            Rule('-A INPUT --src BABE:1:11:1600::/64 -d BABE:1:11:1401::/64 -j ACCEPT'),
            # (ntt3,as1_r14)
            Rule('-A INPUT --src BABE:1:11:1900::/64 -d BABE:1:11:1301::/64 -j ACCEPT'),
            # (equinix2,as1_r14)
            Rule('-A INPUT --src BABE:1:11:1800::/64 -d BABE:1:11:1302::/64 -j ACCEPT'),
            # (telstra1,as1_bb1)
            Rule('-A INPUT --src BABE:1:10:0800::/64 -d BABE:1:10:0302::/64 -j ACCEPT'),
            # (ntt1,as1_bb1)
            Rule('-A INPUT --src BABE:1:10:0303::/64 -d BABE:1:10:0900::/64 -j ACCEPT'),
            # (telstra2,as1_bb2)
            Rule('-A INPUT --src BABE:1:10:0A00::/64 -d BABE:1:10:0404::/64 -j ACCEPT'),
            # (ntt2,as1_bb2)
            Rule('-A INPUT --src BABE:1:10:0B00::/64 -d BABE:1:10:0405::/64 -j ACCEPT'),
            # (equinix1,as1_bb2)
            Rule('-A INPUT --src BABE:1:10:0C00::/64 -d BABE:1:10:0406::/64 -j ACCEPT'),
